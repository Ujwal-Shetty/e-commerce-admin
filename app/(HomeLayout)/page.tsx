...
function HomePage() {
  return (
    <div className='flex'>
      ...
      <p className='h-3/4 text-3xl leading-10'>Ecommerce or electronic commerce refers to a business model that involves sales transactions being done on the web.<p></p><br></br> Virtually every online shopping website - big or small - follows this structure.<p></p> Any site where you can obtain items for sale over the internet is considered an ecommerce website.</p>
      </div>
